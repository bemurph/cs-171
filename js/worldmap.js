...
var mapWidth = 600,
    mapHeight = 500,
    barMargin ={top:30, right:60, bottom:20, left:60},
    ...
    // Create Paths
        ...
        newPath.enter()
              ...
              .on("click", function(d) {
                ...
                d3.select(this).attr("class","activeCountry")
                ...
                if (countryData[d.id]){
                      ...
                      .merge(barChart)
                          .transition()
                          .duration(1000)        
                          .attr("x", function(d) { return barXScale(d.abbr); })
                    ...
                    yAxisGroupBar = barSVG.select(".y-axis-bar")
                     ...
                     d3.select(".bar-axis-text")
                      ...
                      console.log("else");
                      $(".tooltip-bar").html("No Information")
                      .css("left", (d3.event.pageX + 10) + "px")
                      .css("top", (d3.event.pageY + 10) + "px")
                      .css("display","block");
                      }  
